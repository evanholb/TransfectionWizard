...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # Step 4) pipette OM/P3K/DNA mixture into OM/L3K mixture
    ...
    while count < len(L3K_dests):
        ...
        if mixing_vol > 20 and mixing_vol <= 200 and mixing_vol*1.8 <= 200:
            right_pipette.transfer(
                volume = mixing_vol,
                source = source,
                dest = dest,
        ...
        elif mixing_vol <= 20 and mixing_vol*1.8 <= 20:
            left_pipette.transfer(
                volume = mixing_vol,
                source = source,
                dest = dest,
    ...
    # Step 5) Adding transfection mixes to cells
