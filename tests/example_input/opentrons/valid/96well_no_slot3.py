...
# metadata
metadata = {
    "protocolName": "96well Layout Missing Slot 3 Test",
    "author": "Test",
    "description": "Tests 96well layout with optional slot 3 missing (slots 2, 4, 5, 6)"
}
...
def run(protocol: protocol_api.ProtocolContext):
    # load labware - 96WELL WITHOUT SLOT 3: slots 2, 4, 5, 6
