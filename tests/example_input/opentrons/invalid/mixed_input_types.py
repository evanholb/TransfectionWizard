...
# metadata
metadata = {
    "protocolName": "Invalid: Mixed Input Types Test",
    "author": "Test",
    "description": "Tests invalid layout with inconsistent input types (tube + tube + 96well)"
}
...
def run(protocol: protocol_api.ProtocolContext):
    # load labware - INVALID: Mixed types that don't match either layout
    # Slots 4, 5 are tube racks but slot 6 is 96-well plate
